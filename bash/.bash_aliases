...
alias epll='eval `pillar env local.pillar`'
alias epld='eval `pillar env adalpha.dev`'
alias eplt='eval `pillar env adalpha.tech`'
alias eplp='eval `pillar env ajbelltouch.co.uk`'
